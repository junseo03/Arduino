...
// Servo adjustment
#define _DUTY_NEU 1328  // Servo angle: 0 degree
#define _DUTY_MAX 1628  // Servo angle: D degree
#define _DUTY_MIN 628   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 80 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

// PID parameters
#define _KP 4.5 // proportional gain
...
{
  return  1224+-9.48*a_value+0.0341*pow(a_value,2)+-5.53E-05*pow(a_value,3)+3.23E-08*pow(a_value,4); // Replace this with the equation obtained from nonlinear regression analysis
}
