...
// Servo adjustment
#define _DUTY_MAX 1728  // Servo angle: D degree
#define _DUTY_NEU 1328  // Servo angle: 0 degree
#define _DUTY_MIN 728   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1154+-9.48*a_value+0.0341*pow(a_value,2)+-5.53E-05*pow(a_value,3)+3.23E-08*pow(a_value,4);
}
